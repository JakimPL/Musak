...
def main() -> None:
    ...
    _LOGGER.info("n range: %s..%s", config.figure_analysis.min_n, config.figure_analysis.max_n)
    _LOGGER.info("Limit per group: %s", config.figure_analysis.limit_per_group)
