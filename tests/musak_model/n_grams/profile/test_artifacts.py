...
def test_figure_artifact_paths_resolve_under_encoded_run() -> None:
    ...
    assert paths.counts_path == Path("processed/PDMX/encoded/abc/figure/all/counts.parquet")
    assert paths.base_durations_path == Path("processed/PDMX/encoded/abc/figure/all/base_durations.parquet")
