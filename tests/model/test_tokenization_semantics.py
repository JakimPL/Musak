...
def test_chord_tokenization_preserves_all_chord_pitches() -> None:
    ...
    tokens = _chord_to_tokens(
        ...
        duration_vocabulary=_vocabulary(),
    )
...
def test_unified_stream_rejects_overlapping_non_chord_notes() -> None:
    ...
    with pytest.raises(ValueError, match="overlapping events"):
        _tokenize_unified_stream(score=score, scale_type=ScaleType.MAJOR, duration_vocabulary=_vocabulary())
