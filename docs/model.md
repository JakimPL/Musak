...
The event objective is unchanged. Generation does not supply a planned harmony yet, so harmony-enabled models fall
back to the all-unknown harmonic context until a generation plan provider is added.
