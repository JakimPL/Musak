...
metrics measure long and whole-bar note stasis, melodic contour, large-leap recovery, delayed hand responses,
synchronized onsets, static long left-hand support under moving right hand, and final-position closure. They are
diagnostics only and are not part of the sample penalty, sampling constraints, or training objective.
