...
class SettingsForm(forms.Form):
    ...
    time_signature_numerator = forms.IntegerField(
        label="Time signature",
        min_value=MIN_TIME_SIGNATURE_NUMERATOR,
        max_value=MAX_TIME_SIGNATURE_NUMERATOR,
        initial=TIME_SIGNATURE_NUMERATOR,
    )
    time_signature_denominator = forms.IntegerField(
        label="Time signature",
        min_value=MIN_TIME_SIGNATURE_DENOMINATOR,
        max_value=MAX_TIME_SIGNATURE_DENOMINATOR,
