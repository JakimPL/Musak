...
from inversions.services import default_settings, get_chords_definitions, get_settings
...
def inversion_config(request) -> JsonResponse:
    from core.inversions.service import InversionService

    config = InversionService().get_config()
